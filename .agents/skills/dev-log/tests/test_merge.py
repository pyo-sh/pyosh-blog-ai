...
def test_lock_merge_success(mock_fetch, mock_rebase, mock_merge, mock_rev, tmp_path):
...
@patch("dev_log.merge.fetch")
def test_lock_merge_rebase_abort(mock_fetch, mock_rebase, mock_abort, mock_merge, tmp_path):
    (tmp_path / ".workspace").mkdir()
