...
> 모든 공개 페이지에 동적 메타데이터(title, description, OpenGraph, Twitter Card, canonical URL)를 제공하고, sitemap.xml, RSS 피드, robots.txt를 Next.js에서 생성한다.

## SPEC 참조

- `docs/client/specs/seo-meta.md`
