...
> 글 상세 페이지(F-02)에서 사이드바(F-39) 최상단에 목차(Table of Contents)를 표시한다. 마크다운 본문의 h1/h2/h3 heading을 추출하여 계층적으로 표시하고, 클릭 시 해당 섹션으로 스크롤한다.
