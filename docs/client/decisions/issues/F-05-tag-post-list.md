...
> 태그 slug 기반 글 목록 페이지. 선택한 태그가 연결된 글을 페이지네이션하여 표시한다.

## SPEC 참조

- `docs/client/specs/tag-post-list.md`

## 와이어프레임

- `docs/client/designs/public/category-tag-list.html` - 카테고리/태그별 글 목록 페이지 (태그 필터 적용)
