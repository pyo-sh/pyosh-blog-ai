...
| 날짜       | 주요 작업                            | 상태 |
| ---------- | ------------------------------------ | ---- |
| 2026-03-14 | #43 Admin 대시보드 페이지 PR #136 머지, #45 Admin 글 목록 페이지 PR #137 머지, #44 Admin Post API functions PR #135 머지, #28 CategoryNav 위젯 PR #134 머지, #27 글로벌 loading/error/not-found 페이지 PR #133 머지, #26 Public Post API functions PR #131 머지, #32 Pagination 공통 컴포넌트 PR #128 머지, #30 PostContent + PostNavigation PR #132 머지 | ✅   |
